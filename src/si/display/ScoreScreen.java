...
public class ScoreScreen extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        drawString(g, "Asteroids Hall of Fame", new Rectangle(0, 0, AsteroidsGame.SCREEN_WIDTH, AsteroidsGame.SCREEN_HEIGHT / 8),
                36);
        ...
        for (int i = 0; i < scores.length; i++) {
            ...
            //当有分数产生和录入时才可使用否则会得到空对象
            g.drawString(score.getName(), 2 * AsteroidsGame.SCREEN_WIDTH / 6, 96 + i * 32);
            g.drawString("" + score.getScore(), 4 * AsteroidsGame.SCREEN_WIDTH / 6, 96 + i * 32);
        }
